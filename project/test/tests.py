...
from data.dataframer import DataObj
...
class TestDBWriter(unittest.TestCase):
    ...
    def test_import_json_extract(self):

        from database.db_managers import DBWriter as dbw # todo local scope

        # todo tearup/teardown
        ...
        price = extract['texts'][25]['text'][0]

        # print(repr(price), repr('£16.66'))
        # in database shows as: Â£16.66
        # https://stackoverflow.com/questions/1461907/html-encoding-issues-%C3%82-character-showing-up-instead-of-nbsp
        # somehow encoded in the json file


    def test_store_page_extract(self):
        ...
        url = extract.pop('url')
        self.assertEqual(url, 'https://www.boots.com/loreal-paris-revitalift-filler-serum-30ml-10274580')
...
class TestDataObjs(unittest.TestCase):
